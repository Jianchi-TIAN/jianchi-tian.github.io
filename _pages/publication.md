...
======
  ...
  15. **Tian, J.,** Dewitte, S., Zeng, C., Lee, T. M., Pan, R., Sun, Y. (submitted) Artificial Intelligence’s Understanding of the Human-Nature Relationship. _Science Advances_
  16. **Tian, J.,** Gong, Y., Lee, T. M., & Sun, Y. (submitted). Communicating environmental information leads to increased climate policy support. _Climatic Change_
  ...
  20. **Tian, J.,** Gong, Y., Sun, M., & Sun, Y. (working paper). Uncovering Complex Relationships: Advancing Climate Change Research with Bayesian Kernel Machine Regression.
<br><br>
